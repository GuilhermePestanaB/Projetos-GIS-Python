...
# MCDA descomissionamento subsea AHP Python

#utilizacao de AHP em python para auxilio na tomada de decisao das alternativas de descomissionamento 
# de dutos submarinos (CASO HIPOTETICO)
#Autoria propria fruto de um trabalho de doutorado de MCDA.
